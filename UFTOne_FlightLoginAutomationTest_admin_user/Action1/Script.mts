...
If WpfWindow("Micro Focus MyFlight Sample").WpfButton("FIND FLIGHTS_2").Exist(5) Then
	...
	Reporter.ReportEvent micWarning, "Passed Test", "user password need to be updated ASAP"
End If @@ hightlight id_;_1931996136_;_script infofile_;_ZIP::ssf16.xml_;_
Reporter.ReportEvent micDone, "Login Done","the Flight App Done login passed but user password need to be updated  "
